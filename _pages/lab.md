...
통계 이론과 방법론의 발전뿐만 아니라 연구 결과가 실제 데이터 분석으로 이어지는 것을 중요하게 생각합니다. 천문학, 입자물리학, 신경과학, 바이오메카닉스, 품질관리, 역학, 디지털 인문학, 계산사회과학 등 다양한 분야의 연구자들과 협력하며, 과학적 질문을 통계적 문제로 다시 정의하고 재현 가능한 분석을 통해 답을 찾고자 합니다.
...
특히 많은 후보 신호를 동시에 탐색할 때 발생하는 계산 부담과 오발견 가능성을 줄이고, 약한 신호에 대한 검정력을 높이는 것을 목표로 합니다. 이를 위해 고차원 추론, 결합검정, 이상신호 탐지 및 불확실성 정량화 방법을 입자물리학 자료의 특성에 맞게 발전시키고 있습니다.

### Modern dependency measures
...
학부 연구인턴은 지도 아래 논문 읽기, 데이터 분석, 시뮬레이션 및 프로그래밍을 경험하며 통계 연구의 전 과정을 배울 수 있습니다. 대학원생은 고차원 통계, 다중검정, 입자물리학을 위한 통계적 추론, modern dependency measures, 순차검정, conformal prediction, 변화점 탐지, 품질관리, 통계적 학습, 함수형 자료분석, 바이오메카닉스 또는 공간통계 가운데 자신의 관심에 맞는 연구주제를 발전시킬 수 있습니다.
